  ...
  const renderFunnel = () => {
    ...
    return (
      <svg width={svgWidth} height={svgHeight} className="mx-auto" viewBox={`0 0 ${svgWidth} ${svgHeight}`}>
        ...
        {/* Labels de ejes */}
        <text x="15" y="100" fontSize="11" fill="#A0A0A0" fontStyle="italic">
          Number of
        </text>
        <text x="15" y="115" fontSize="11" fill="#A0A0A0" fontStyle="italic">
          prospective
        </text>
        <text x="15" y="130" fontSize="11" fill="#A0A0A0" fontStyle="italic">
          purchasers
        </text>

        <text x={svgWidth - 150} y="35" fontSize="12" fill="#A0A0A0" fontWeight="600">
          Web Page Visits
        </text>
        <text x={svgWidth - 150} y="130" fontSize="12" fill="#A0A0A0" fontWeight="600">
          Interested users
        </text>
        <text x={svgWidth - 150} y="245" fontSize="12" fill="#A0A0A0" fontWeight="600">
          Total Intent Score
        </text>
      </svg>
    );
